...
class LinkedList:
    ...
    def add(self, data):
        """
        New node containing data at head of the list 
    ...
    def remove(self, key):
        """
        Removes node containing data that matches the data
    ...
    def search(self, key):
        ...
        Takes O(n) linear time since it needs traverse through the linked list
        """
